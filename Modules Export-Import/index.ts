...
export const companies: Companies[] = [
  {
    ...
    services:
      "Search engine, online advertising technologies, cloud computing, software, and hardware",
    stockDetails: {
...

  {
    ...
    type: "Public",
    services:
      "Software, cloud computing, personal computing, AI, gaming, enterprise services",
    stockDetails: {
      stockName: "MSFT",
...

  {
    ...
    type: "Public",
    services:
      "E-commerce, cloud computing, digital streaming, artificial intelligenc",
    stockDetails: {
      stockName: "AMZN",
...

  {
    ...
    type: "Public",
    services:
      "Social networking, advertising, virtual reality, messaging services",
    stockDetails: {
      stockName: "META",
...

  {
    ...
    type: "Public",
    services:
      "Streaming media, video-on-demand, film production, television production",
    stockDetails: {
      stockName: "NFLX",
...

  {
    ...
    founderName:
      "Elon Musk (among others including: JB Straubel, Martin Eberhard, Marc Tarpenning, Ian Wright)",
    wordWideEmp: "Approximately 127,800+ (as of 2023)",
    netWorth: "Tesla's Nerworth: $" + 835 + " billion (as of 2024)",
    type: "Public",
    services:
      "Electric vehicles, battery energy storage, solar energy solutions",
    stockDetails: {
      stockName: "TSLA",
...
console.log(companies.filter(company => company.stockDetails.stockPrice).map(company => company.stockDetails.stockPrice));